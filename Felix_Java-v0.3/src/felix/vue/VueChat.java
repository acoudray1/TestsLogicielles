...
public class VueChat extends VueFelix implements ActionListener, Runnable {
	...
	private void construireControles(Integer largeur, Integer hauteur) {
		...
		this.texteMessage.setName(Felix.CONFIGURATION.getString("FENETRE_CHAT_MESSAGE"));
		...
		this.texteChatMessages.setName(Felix.CONFIGURATION.getString("FENETRE_CHAT_CHAT"));
